...
import (
	...
	"github.com/smallbiznis/smallbiznis-auth/internal/domain/oauth"
	"github.com/smallbiznis/smallbiznis-auth/sqlc"
)

// OAuthProviderConfigRepo exposes CRUD operations for tenant IdP configs.
type OAuthProviderConfigRepo interface {
	GetProvidersByTenant(ctx context.Context, tenantID int64) ([]oauth.OAuthProviderConfig, error)
	GetProviderByName(ctx context.Context, tenantID int64, name string) (*oauth.OAuthProviderConfig, error)
}
...
func (r *PostgresOAuthProviderConfigRepo) GetProvidersByTenant(ctx context.Context, tenantID int64) ([]oauth.OAuthProviderConfig, error) {
...
func (r *PostgresOAuthProviderConfigRepo) GetProviderByName(ctx context.Context, tenantID int64, name string) (*oauth.OAuthProviderConfig, error) {
	rows, err := r.q.ListOAuthIDPConfigs(ctx, tenantID)
	if err != nil {
